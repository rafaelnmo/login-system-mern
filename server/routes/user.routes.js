...
// route that define the endpoint to create a new user (POST)
router.route("/api/users").post(userCtrl.create);

// route that define the endpoint to fetch all the users in the db (GET)
...
// route that define the endpoint to update a sigle user's data (PUT)
router
	.route("/api/users/:userId")
	.put(authCtrl.requireSignin, authCtrl.hasAuthorization, userCtrl.update);

// route that define the endpoint to delete a user (DELETE)
router
	.route("/api/users/:userId")
